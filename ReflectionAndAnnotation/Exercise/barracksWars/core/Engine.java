...
public class Engine implements Runnable {
	...
	private static final String COMMANDS_PATH_NAME = "src.main.java.ReflectionAndAnnotation.Exercise.barracksWars.core.commands.";
	...
	private String interpretCommand(String[] data, String commandName) {
		...
		try {
			...
			Method executeMethod = clazz.getDeclaredMethod(METHOD_NAME);
